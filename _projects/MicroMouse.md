...
layout: page
title: MicroMouse
description: Build a compact, high-speed autonomous maze-solving robot from scratch using the ESP32-S3, combining embedded systems, custom PCB design, sensing, and path planning.
importance: 2
---
